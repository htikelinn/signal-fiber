...
export default function App() {
    ...
    const markers = [
        { lat: 16.8273665, lng: 96.1358107 }, // Main Point
        { lat: 16.827993, lng: 96.1276461 }, // Another point
        { lat: 16.831197, lng: 96.134255 }, // Another point
    ];
    const zoom = 12;
    ...
    const currentCenter =
        selected === "marker1" ? markers[0] : selected === "marker2" ? markers[1] : selected === "marker3" ? markers[2] : center;

    return (
        // Main Container
        <div className="max-w-4xl mx-auto p-6 space-y-6">
            <h1 className="text-3xl font-bold text-center text-indigo-600">Main Cable Map</h1>
            ...
            <div className="flex flex-col sm:flex-row justify-center items-center gap-3">
                ...
                >
                    ...
                    <option value="marker2">Marker 3</option>
                </select>
